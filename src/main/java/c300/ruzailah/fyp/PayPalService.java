...
public class PayPalService {
    ...
    public JSONObject createPayment(double amount, String currency, String description, long userID, String recipientEmail) throws IOException {
        ...
        if (responseCode == HttpURLConnection.HTTP_CREATED) { 
            ...
            throw new IOException("Failed to create payment. Response code: " + responseCode + ", Response: " + jsonResponse);
        }
    }
    ...
    public void executePayment(String paymentId, String payerId) throws IOException {
        ...
        if (responseCode != HttpURLConnection.HTTP_OK) {
            throw new IOException("Failed to execute payment. Response code: " + responseCode + ", Response: " + jsonResponse);
        }
    }
    ...
    public JSONObject getPaymentDetails(String paymentId) throws IOException {
        ...
        if (responseCode == HttpURLConnection.HTTP_OK) {
            ...
            throw new IOException("Failed to fetch payment details. Response code: " + responseCode + ", Response: " + jsonResponse);
        }
    }
